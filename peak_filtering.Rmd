...
computeMatrix reference-point -S ./coverage_ChIP-nexus_CPM/Cbf12*plus*.bw -R ./peaks_filtered/Cbf12.reproducible_untagged+Fkh2-filtered.summits.bed -a 400 -b 400 -o ./tmp/matrix_fin12_CPM
plotHeatmap -m matrix_fin12_CPM -o ./tmp/test_fin12_CPM.svg --sortUsing sum --sortUsingSamples 2 --missingDataColor red --colorMap Greys 
```
